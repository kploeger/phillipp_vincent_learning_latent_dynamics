...
def plot_loss(history):
    ...
    plt.ylim([0, 10])
    plt.xlabel("Epoch")
    plt.ylabel("Error [joint_state_effort_joint4]")
    plt.legend()
    plt.grid(True)
...
column_names = [
    "joint_state_pos_joint4",
    "joint_state_vel_joint4",
    "joint_state_acc_joint4",
...
train_labels = train_features.pop("joint_state_effort_joint4")
test_labels = test_features.pop("joint_state_effort_joint4")
